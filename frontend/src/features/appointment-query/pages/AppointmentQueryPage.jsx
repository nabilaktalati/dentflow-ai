...
function AppointmentQueryPage() {
  ...
  <div className="pointer-events-none absolute right-5 top-6 rotate-[-10deg] text-[#5956F5] opacity-[0.025]">
    <CalendarCheck2 size={150} strokeWidth={1} />
  </div>
            ...
            <form onSubmit={handleSubmit} className="mt-9">
              ...
              >
                ...
                <input
                  ...
                  onChange={(event) => {
                    setAppointmentCode(event.target.value)

                    if (status !== 'idle') {
                      setStatus('idle')
                    }
                  }}
                  placeholder="DNT-2026-1842"
                  autoComplete="off"
            ...
            <AnimatePresence>
              {status === 'preview' && (
                <motion.div
                  ...
                  className="mt-5 rounded-[18px] border border-[#5956F5]/10 bg-[#5956F5]/[0.045] p-4"
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-xs leading-5 text-slate-500">
                        Randevu bilgileri backend entegrasyonu sonrasında
