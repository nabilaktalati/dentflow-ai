...
export default function RegisterPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f7f8fc] pt-24 lg:pt-28">
      <div className="mx-auto flex min-h-[calc(100vh-7rem)] max-w-[1380px] items-center px-4 py-8 sm:px-6 lg:px-8">
        <div className="relative w-full overflow-hidden rounded-[34px] border border-slate-200/80 bg-white shadow-[0_30px_100px_rgba(15,23,42,0.10)]">
          {/* DESKTOP */}
          <div className="relative hidden min-h-[660px] xl:block">

            {/* WHITE CONTENT LAYER */}
            <div className="absolute inset-0 z-10 grid grid-cols-2">

              {/* LEFT SIDE */}
              <div className="flex items-center justify-center px-14 py-8 xl:px-20">
  ...
  <span className="block">
    burada başlar.
      ...
      <p className="mt-7 max-w-md text-[15px] leading-7 text-white/72">
        ...
        klinik iletişiminizi yönetin ve
        hasta sürecinize güvenli
        hesabınızdan erişin.
      </p>
  ...
  return (
    ...
    >
      ...
      <p className="mt-7 text-[15px] leading-7 text-white/70">
        Hesabınız oluşturuldu. Size
        gönderilen 6 haneli kodla
...
function RegisterContent({
  ...
  return (
    <div>
      ...
      <h2 className="mt-3 text-[32px] font-semibold tracking-[-0.045em] text-slate-950">
...
function VerificationContent({
  ...
  return (
    <div>
      <div className="flex size-12 items-center justify-center rounded-2xl bg-indigo-50 text-[#5B52F2]">
        <KeyRound size={22} />
      </div>
...
function SuccessContent({ message }) {
  return (
    <div className="text-center">
      ...
      <Link
        to="/login"
        className="group mt-8 inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-[#5B52F2] px-8 text-sm font-semibold text-white shadow-[0_14px_34px_rgba(91,82,242,0.24)] transition hover:bg-[#5047e8]"
      >
        Giriş Yap
